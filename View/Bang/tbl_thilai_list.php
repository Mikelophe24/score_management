                  ...
                  <tr>
                    ...
                    <td>
                    	<select class="select_trangthai">
                    		...
                    		<option <?php echo $value['trangthai'] == 0?'selected':'';  ?> value="1" data-action="/<?php echo $globalUrlAlias;?>/index.php?controllers=quanly&action=Thi_lai&acplus=edit&ma_sv=<?php echo $value['ma_sv']; ?>&ma_mon=<?php echo $value['ma_mon']; ?>&trangthai=0">Chưa thi lại</option>
                    	</select>
                    </td>
                    <td>
