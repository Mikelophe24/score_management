<ul class="sidebar navbar-nav">
	...
	<li class="nav-item">
		<a class="nav-link dropdown-toggle" href="#" id="pagesDropdownOther" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			<i class="fas fa-fw fa-folder"></i>
			<span>Quản lý khác</span>
		</a>
		<div class="dropdown-menu" aria-labelledby="pagesDropdownOther">
			<a class="dropdown-item" href="index.php?controllers=quanly&action=Thi_lai">
				Danh sách SV thi lại
			</a>
			<a class="dropdown-item" href="index.php?controllers=quanly&action=Hoc_lai">
				Danh sách SV học lại
			</a>
			<a class="dropdown-item" href="index.php?controllers=quanly&action=Hoc_bong">
